<script>
    ...
    function appState() {
        return {
            ...
            colorThemes: [
                { name: 'Cyber Punk', start: '#1d4ed8', end: '#7c3aed' },
                { name: 'Sunset Glow', start: '#f43f5e', end: '#fb923c' },
                { name: 'Emerald Forest', start: '#059669', end: '#34d399' },
                { name: 'Ocean Vibe', start: '#0ea5e9', end: '#22d3ee' },
                { name: 'Midnight Blue', start: '#2563eb', end: '#db2777' },
                { name: 'Gold Rush', start: '#d97706', end: '#fcd34d' },
                { name: 'Indigo Night', start: '#3730a3', end: '#818cf8' },
                { name: 'Rose Petal', start: '#be123c', end: '#fb7185' },
                { name: 'Teal Ocean', start: '#115e59', end: '#2dd4bf' },
                { name: 'Violet Dream', start: '#7c3aed', end: '#a78bfa' },
                { name: 'Fuchsia Pop', start: '#c026d3', end: '#e879f9' },
                { name: 'Lime Zest', start: '#65a30d', end: '#a3e635' },
                { name: 'Aurora Sky', start: '#0d9488', end: '#a855f7' },
                { name: 'Sakura Bloom', start: '#ec4899', end: '#f97316' },
                { name: 'Nebula Space', start: '#1e3a8a', end: '#c026d3' },
                { name: 'Amber Fire', start: '#b45309', end: '#facc15' },
                { name: 'Royal Smoke', start: '#6A0DAD', end: '#1C1C1C' },
