...
class SiteSetting extends Model
{
     ...
     */
    public static function getTailwindIcons(): array
    {
        return [
            'none' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>',
            ...
            'cube' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>',
            ...
            'beaker' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.388 24.388 0 015.963 0m0 0c.251-.032.501-.059.75-.082m-.75.082v5.714c0 .597.237 1.17.659 1.591l4.136 4.136m-9-1.579l-4.136 4.136c-2.454 2.454 1.393 6.297 5.297 3.535l4.809-4.809m-4.809 4.809c2.616-2.616 8.563-1.028 10.609.608" /></svg>',
            ...
            'gift' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M21 11.25v8.25a1.5 1.5 0 01-1.5 1.5H4.5a1.5 1.5 0 01-1.5-1.5v-8.25M3 11.25h18M3 11.25a2.25 2.25 0 00-2.247-2.118v0c-.882.882-2.247 2.247-2.247 4.118 0 1.872 1.365 3.237 2.247 4.118 0v0a2.25 2.25 0 002.247-2.118m0-4.118v4.118m0-4.118c.882-.882 2.247-2.247 2.247-4.118 0-1.872-1.365-3.237-2.247-4.118-2.247 0-3.237 1.365-4.118 2.247C12 7.749 12 11.25 12 11.25m0-4.118c-.882-.882-2.247-2.247-2.247-4.118 0-1.872 1.365-3.237-2.247-4.118 2.247 0 3.237 1.365 4.118 2.247" /></svg>',
        ];
    }
}
